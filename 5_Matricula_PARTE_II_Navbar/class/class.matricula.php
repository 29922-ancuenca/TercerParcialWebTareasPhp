...
class Matricula{
	...
	public function get_form($id=NULL){
		...
		if($bandera){
			...
			$html = '
			<form name="Form_matricula" method="POST" action="index_matricula.php">
				...
				<table border="2" align="center">
					...
					<th colspan="2"><a href="index_matricula.php">Regresar</a></th>
				</table>
			</form>';
	...
	public function get_list(){
		...
		<table border="1" align="center">
			...
			<tr>
				<th colspan="7"><a href="index_matricula.php?d=' . $d_new_final . '">Nuevo</a></th>
			</tr>
			<tr>
				<th>Fecha</th>
				<th>Vehiculo</th>
			...
			while($row = $res->fetch_assoc()){
				...
				$html .= '
					<tr>
						...
						<td>' . $row['agencia'] . '</td>
						<td>' . $row['anio'] . '</td>
						<td><a href="index_matricula.php?d=' . $d_del_final . '">Borrar</a></td>
						<td><a href="index_matricula.php?d=' . $d_act_final . '">Actualizar</a></td>
						<td><a href="index_matricula.php?d=' . $d_det_final . '">Detalle</a></td>
					</tr>';
			}
